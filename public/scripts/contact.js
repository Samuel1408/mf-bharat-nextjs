// Inline script for contact.html
const cf = document.getElementById('contactForm');
  if (cf) cf.addEventListener('submit', e => {
    e.preventDefault();
    cf.innerHTML = '<div style="text-align:center;padding:40px 0;"><div style="font-size:48px;margin-bottom:16px;">&#10003;</div><div style="font-size:20px;font-weight:800;color:var(--text-primary);margin-bottom:8px;">Message sent!</div><div style="color:var(--text-sec);font-size:14px;">We will get back to you within one business day.</div></div>';
  });
